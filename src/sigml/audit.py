...
def emit_lean_certificate(
    onto: Ontology, findings: list[Finding],
    namespace: str = "AuditCert", source: str = "a learned order embedding",
) -> str:
    ...
    become KonceptDefCCD terms (inhabiting the verified spec's type is the
    ...
    lines = [
        ...
        "",
        f"Generated by src/sigml/audit.py from {source}.",
